...
const Header = () => {
  ...
  return (
    <div className="w-full fixed top-0 left-0 z-50 bbg-n-8/90 backdrop-blur-sm border-b border-y-n-6 lg:bg-n-8/90 lg:backdrop-blur-sm">
          ...
          <div className="relative z-2 flex flex-col items-center justify-center m-auto lg:flex-row">
            {navigation.map((item) => (
              <a
                ...
                } px-6 py-6 md:py-8 lg:text-xs lg:font-semibold ${item.url===pathname.hash ? 'z-2 lg:text-n-1': 'lg:text-n-1/50' } lg:leading-5 lg:hover:text-n-1 xl:px-12`}
              >
                {item.title}
              </a>
            ))}
